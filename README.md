...
1. Copy every file to the same folder "Digimon Story CS.exe" is located
2. Rename "Digimon Story CS.exe" to "Digimon Story CS.OG.exe"
3. Rename "Digimon Story CS keyboard fix.exe" to "Digimon Story CS.exe"
